    ...
    <footer className="border-t border-border bg-background text-foreground">
      <div className="container mx-auto px-4 pt-16 md:pt-20 pb-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            <h4 className="mb-4 text-sm font-semibold text-foreground">Acesso Rápido</h4>
            <ul className="space-y-2 text-sm text-foreground/62">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/62">
              <li><a href="https://www.instagram.com/hype.delivery_/" target="_blank" rel="noopener noreferrer" className="hover:text-primary">Instagram: @hype.delivery_</a></li>
        ...
        <div className="mt-12 border-t border-border pt-6 text-xs text-foreground/45 flex flex-col md:flex-row justify-between items-center gap-4">
