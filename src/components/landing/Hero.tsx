        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            <motion.div 
              ...
              className="mb-6 inline-flex items-center gap-2 border border-white/20 bg-black/30 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.12em] text-white backdrop-blur"
            >
            ...
            <motion.p 
              ...
              className="mb-10 max-w-2xl text-lg leading-relaxed text-white/78 md:text-xl"
            >
            ...
            <motion.div 
              ...
              className="mt-12 grid max-w-2xl grid-cols-1 gap-3 text-sm text-white/76 sm:grid-cols-3"
            >
