...
export const Hero = () => {
  return (
    <section className="relative min-h-[86svh] overflow-hidden bg-background pt-24 text-foreground md:pt-28">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-background via-background via-[58%] to-transparent" />
      <div className="absolute inset-x-0 bottom-0 h-20 bg-[linear-gradient(180deg,transparent_0%,var(--background)_100%)]" />
      ...
      <div className="container relative mx-auto px-4 pb-20">
        <div className="grid items-center gap-12 lg:min-h-[calc(86svh-7rem)] lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
          ...
          >
            <motion.div 
              ...
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.08em] text-foreground backdrop-blur"
            >
            ...
            >
              ...
              <Button variant="outline" size="xl" className="bg-card/80" asChild>
            ...
            <motion.div 
              ...
              className="mt-12 grid max-w-2xl grid-cols-1 gap-3 text-sm text-muted-foreground sm:grid-cols-3"
            >
        ...
        <motion.div 
          ...
          className="relative mt-10 block overflow-hidden rounded-lg bg-black lg:hidden"
        >
